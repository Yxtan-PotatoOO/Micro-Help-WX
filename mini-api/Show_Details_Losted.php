...
$sql = "SELECT a.id,a.usrID,a.sendDateTime,a.status,a.imgUrl1,a.imgUrl2,a.lostedAddress,a.lostedTime,a.lostedRemarks,a.phone,a.contactID,a.comTime,b.grade,b.nickName,b.avatarUrl FROM tb_LostedInfo a, tb_users b WHERE a.usrID = b.openID and a.usrID = '$usrID' and b.usrStatus = 0 order by case when a.status=0 then 1 else 0 end DESC, a.sendDateTime DESC";
...
if (mysqli_num_rows($result) > 0) {
	while($row = mysqli_fetch_assoc($result)) {
		...
		if($tb_lostedinfo -> status == 0){
			...
			$tb_lostedinfo -> staClass = '';
		}
		else{
			$tb_lostedinfo -> status = "已找回";
			$tb_lostedinfo -> staClass = 'fin';
		}

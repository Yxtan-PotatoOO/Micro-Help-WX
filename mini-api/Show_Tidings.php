...
$sql = "SELECT a.id,a.usrID,a.sendDateTime,a.status,a.tidingsRemarks,a.imgUrl1,a.imgUrl2,a.imgUrl3,b.grade,b.nickName,b.avatarUrl FROM tb_tidings a, tb_users b WHERE a.usrID = b.openID order by a.sendDateTime DESC";
